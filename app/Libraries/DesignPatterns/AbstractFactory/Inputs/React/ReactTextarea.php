 ...
 */
class ReactTextarea implements InputInterface
{
    ...
    {
        $html = '<label> This is React Textarea:';
        $html .= '<textarea value={this.state.value} onChange={this.handleChange} type="' . $this->getType() . '" name="' . $this->getName() . '" id="' . $this->getId() . '" class="' . $this->getClass() . '"></textarea>';
        $html .= '</label>';
        if (!$return) {
            echo $html;
        }
